...
class Settings():
    ...
    def globalSettings(self):
        ...
        labelframe2 = tkinter.LabelFrame(labelframe, bg=consts.MENU_COLOR, fg='red', bd=3, relief='flat')
        labelframe2.grid(row=0, column=0, sticky='NEWS')
        shortcutLabel = tkinter.Label(labelframe2, text="Label", height=2)
        ...
        commandLabel = tkinter.Label(labelframe2, text="Commands", height=2)
